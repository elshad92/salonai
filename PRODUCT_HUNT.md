...
## Gallery Descriptions (5 screenshot captions)

### 1 — Dashboard
**Clean salon command center**
Real-time bookings for today, week, and month at a glance. The AI Analyst card surfaces plain-English insights from your actual booking data — no spreadsheets required.

### 2 — AI Receptionist (Chat Widget)
**Books appointments while you sleep**
The embedded chat widget sits on any page and guides clients through booking in natural conversation. Powered by Gemini AI — it knows your services, your stylists, and saves confirmed bookings directly to your calendar.

### 3 — WhatsApp AI Administrator
**Your 24/7 WhatsApp booking agent**
Clients text your WhatsApp number, the AI responds in seconds, collects all booking details, and confirms the appointment. Handles cancellations, sends 24h and 1h reminders automatically via Twilio.

### 4 — AI Marketer
**Instagram content on autopilot**
One click generates 5 ready-to-post captions — promos, engagement posts, tips, seasonal content — tailored to your salon name and services. Copy and paste directly to Instagram.
